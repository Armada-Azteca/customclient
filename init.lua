-- CONFIG
APP_NAME = "ArmadaAzteca"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
  website = "http://armada-azteca.com", -- currently not used
  updater = "http://armada-azteca.com/client/updater.php",
  stats = "",
  crash = "http://armada-azteca.com/azteca/crash.php",
  feedback = "http://otclient.ovh/api/feedback.php",
  status = "http://armada-azteca.com/azteca/status.php"
}

-- Servers accept http login url, websocket login url or ip:port:version
Servers = {
  Armada = "ot.armada-azteca.com:7171:961",
  ArmadaTest = "ot.armada-azteca.com:7173:961"
}

--USE_NEW_ENERGAME = true -- uses entergamev2 based on websockets instead of entergame
ALLOW_CUSTOM_SERVERS = false -- if true it shows option ANOTHER on server list

g_app.setName("Armada Azteca")
-- CONFIG END
